<script lang="ts">
  ...
  function calculateRect(element: HTMLElement, selector: HTMLDivElement) {
  ...
  onMount(() => {
    ...
    iFrameContainer.style.height = String(window.innerHeight - 45) + 'px';
    ...
    iFrame.addEventListener('load', () => {
      ...
      iFrameDoc.addEventListener('dragover', (e) => {
        ...
        ghost_img.style.top = e.pageY + 60 + 'px';
        ghost_img.style.left = e.pageX + 75 + 'px';
